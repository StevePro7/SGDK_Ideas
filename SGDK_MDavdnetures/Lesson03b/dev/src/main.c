...
int main()
{
	...
	*/
	...
	while( 1 )
	{
		...
		VDP_setTileMapXY( BG_A, MI_TILE1, 10, 10 );
		VDP_setTileMapXY( BG_A, MI_TILE2, 12, 10 );
		...
		VDP_fillTileMapRect( BG_A, TILE_ATTR_FULL( PAL2, 0, 0, 0, MI_TILE1 ), 0, 21, 40, 1 );
		VDP_fillTileMapRect( BG_A, TILE_ATTR_FULL( PAL1, 0, 0, 0, MI_TILE2 ), 0, 22, 40, 7 );
		...
		VDP_fillTileMapRect( BG_A, TILE_ATTR_FULL( PAL0, 0, 0, 0, MI_TILE1 ), 0, 10, 20, 9 );
		VDP_fillTileMapRect( BG_A, TILE_ATTR_FULL( PAL1, 0, 1, 0, MI_TILE1 ), 20, 10, 20, 9 );
		VDP_fillTileMapRect( BG_A, TILE_ATTR_FULL( PAL2, 0, 0, 1, MI_TILE1 ), 0, 19, 20, 9 );
		VDP_fillTileMapRect( BG_A, TILE_ATTR_FULL( PAL3, 0, 1, 1, MI_TILE1 ), 20, 19, 20, 9 );
