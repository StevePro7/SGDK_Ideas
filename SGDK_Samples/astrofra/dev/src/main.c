...
static void fastStarFieldFX()
{
	...
	numTile = 0;
#ifndef _CONSOLE
	numTile = starfield.tileset->numTile;
#endif
	...
	numFrame = 1;
#ifndef _CONSOLE
	anim = donut.animations[ 0 ];
	numFrame = anim->numFrame;
#endif
	for( i = 0; i < numFrame; i++ )
	{
		...
		tileset = NULL;
#ifndef _CONSOLE
		tileset = anim->frames[ i ]->tileset;
		numTile = tileset->numTile;
#endif
