...
int main()
{
	...
	numTile = 0;
#ifndef _CONSOLE
	numTile = logo_aplib.tileset->numTile;
#endif
	...
	numTile = 0;
#ifndef _CONSOLE
	numTile = logo_ucomp.tileset->numTile;
#endif
	...
	data = NULL;
#ifndef _CONSOLE
	data = logo_aplib.palette->data;
#endif
	//VDP_setPaletteColors( 0, ( u16* ) logo_aplib.palette->data, 16 );
	VDP_setPaletteColors( 0, ( u16* ) data, 16 );

	data = NULL;
#ifndef _CONSOLE
	data = logo_ucomp.palette->data;
#endif
	//VDP_setPaletteColors( 16, ( u16* ) logo_ucomp.palette->data, 32 );
	VDP_setPaletteColors( 16, ( u16* ) data, 32 );
