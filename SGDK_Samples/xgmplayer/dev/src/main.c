...
int main()
{
	u16 i;
	u16 bg_numTile;
	u16 music_logo_numTile;
	u16 progress_bar_numTile;
	u16 starfield_numTile;
	//TileSet bm;
	...
	// init some GFX var
	bg_numTile = 0;
	music_logo_numTile = 0;
	progress_bar_numTile = 0;
	starfield_numTile = 0;
#ifndef _CONSOLE
	bg_numTile = bg.tileset->numTile;
	music_logo_numTile = music_logo.tileset->numTile;
	progress_bar_numTile = progress_bar.tileset->numTile;
	starfield_numTile = starfield.tileset->numTile;
#endif
	//tileIndexProgressBar = TILE_USERINDEX + bg.tileset->numTile + music_logo.tileset->numTile;
	tileIndexProgressBar = TILE_USERINDEX + bg_numTile + music_logo_numTile;
	...
	tileIndex = TILE_USERINDEX + bg_numTile + music_logo_numTile + progress_bar_numTile + starfield_numTile;
...
static void drawStaticGUI()
{
	...
	VDP_drawImageEx( WINDOW, &music_logo, TILE_ATTR_FULL( PAL2, TRUE, FALSE, FALSE, TILE_USERINDEX + bg_numTile ), 21, 0, FALSE, TRUE );
	...
	VDP_drawImageEx( BG_B, &starfield, TILE_ATTR_FULL( PAL0, FALSE, FALSE, FALSE, TILE_USERINDEX + bg_numTile + music_logo_numTile + progress_bar_numTile ), 0, 0, FALSE, TRUE );
	...
	tileset_numTile = 0;
#ifndef _CONSOLE
	tileset_tiles = tileset->tiles;
	tileset_numTile = tileset->numTile;
#endif
	//memcpy( progressTileBuffer, tileset->tiles, tileset->numTile * 32 );
	memcpy( progressTileBuffer, tileset_tiles, tileset_numTile * 32 );
	...
	tileIndexShadowMaskEven = tileIndexShadowMaskOdd + tileset_numTile;
