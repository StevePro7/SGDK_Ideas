...
#include "main.h"     //carga fondos  / load background images
...
int main()
{
	...
	MyTilesetH = unpackTileMap( horizontal_hud.tilemap, NULL );
	...
	MyTilesetV = unpackTileMap( vertical_hud.tilemap, NULL );
...
static void cargaESTADO()
{
	...
	if( estado == 1 ) {  //HUD superior
		...
		VDP_setMapEx( VDP_PLAN_WINDOW, MyTilesetH, TILE_ATTR_FULL( PAL3, TRUE, FALSE, FALSE, ind ), 0, 0, 0, 0, 40, 2 );
		//pinta las puntuaciones en el plano W
		VDP_setTextPlane( VDP_PLAN_WINDOW );
		...
		VDP_drawTextBG( BG_A, "EJEMPLO HUD SUPERIOR ", 10, 9 );
		VDP_drawTextBG( BG_B, "PULSA 'A' sig EJEMPLO", 10, 10 );
	}
	...
	if( estado == 2 ) {  //HUD INFERIOR
		...
		VDP_clearTextArea( 10, 9, 22, 3 );   //borra textos anteriores / delete text from other examples
											 ...
											 //pinta el HUD (utiliza el tileset horizontal)
		VDP_setMapEx( VDP_PLAN_WINDOW, MyTilesetH, TILE_ATTR_FULL( PAL3, FALSE, FALSE, FALSE, ind ), 0, 26, 0, 0, 40, 2 );
		...
		//ahora pinta en los planos
		VDP_drawTextBG( BG_A, "EJEMPLO HUD INFERIOR ", 10, 9 );
		VDP_drawTextBG( BG_B, "PULSA 'B' sig EJEMPLO", 10, 10 );
	}
	...
	if( estado == 3 ) {  //HUD IZQUIERDO
		...
		VDP_setMapEx( VDP_PLAN_WINDOW, MyTilesetV, TILE_ATTR_FULL( PAL3, FALSE, FALSE, FALSE, ind2 ), 0, 0, 0, 0, 4, 28 );
		//pinta las puntuaciones en el plano W
		VDP_setTextPlane( VDP_PLAN_WINDOW );
		...
		//ahora pinta en los planos
		VDP_drawTextBG( BG_A, "EJEMPLO HUD IZQUIERDA", 10, 9 );
		VDP_drawTextBG( BG_B, "PULSA 'C' sig EJEMPLO", 10, 10 );
	}
	...
	if( estado == 4 ) {  //HUD DERECHO
		...
		VDP_clearTextArea( 10, 9, 22, 3 );   //borra textos anteriores / delete text from other examples
											 ...
											 //pinta el HUD (utiliza el tileset vertical)
		VDP_setMapEx( VDP_PLAN_WINDOW, MyTilesetV, TILE_ATTR_FULL( PAL3, FALSE, FALSE, FALSE, ind2 ), 36, 0, 0, 0, 4, 28 );
		//pinta las puntuaciones en el plano W
		VDP_setTextPlane( VDP_PLAN_WINDOW );
		...
		//ahora pinta en los planos
		VDP_drawTextBG( BG_A, "EJEMPLO HUD DERECHA  ", 10, 9 );
		VDP_drawTextBG( BG_B, "PULSA 'A' sig EJEMPLO", 10, 10 );
	}
	...
	if( estado == 5 ) //HUD SUPERIOR CON PRIORIDAD
	{
		...
		VDP_drawTextBG( BG_B, "Shadow/Hightlight working", 10, 10 );
		VDP_drawTextBG( BG_B, "PULSA 'B' sig EJEMPLO    ", 10, 10 );
	...
	if( estado == 6 ) //HUD SUPERIOR SIN PRIORIDAD
	{
		...
		VDP_clearTextArea( 10, 9, 22, 3 );   //borra textos anteriores / delete text from other examples
											 ...
											 //pinta el HUD (utiliza el tileset horizontal)
		VDP_setMapEx( VDP_PLAN_WINDOW, MyTilesetH, TILE_ATTR_FULL( PAL3, FALSE, FALSE, FALSE, ind ), 0, 0, 0, 0, 40, 2 );
		//pinta las puntuaciones en el plano W
		VDP_setTextPlane( VDP_PLAN_WINDOW );
		intToStr( P1score, txt1, 0 ); VDP_drawText( txt1, 4, 1 );
		intToStr( highscore, txt2, 0 ); VDP_drawText( txt2, 20, 1 );
	...
	if( estado == 7 ) {  //HUD superior+izquierda
		...
		intToStr( P2score, txt3, 0 ); VDP_drawText( txt3, 0, 23 );
		//ahora pinta en los planos
		VDP_drawTextBG( BG_A, "HUD SUPERIOR+IZQUIERDA", 10, 9 );
		VDP_drawTextBG( BG_B, "PULSA 'A' sig EJEMPLO", 10, 10 );
	}
	...
	if( estado == 8 ) {  //HUD inferior+derecha
		...
		//ahora pinta en los planos
		VDP_drawTextBG( BG_A, "HUD INFERIOR+DERECHA  ", 10, 9 );
		VDP_drawTextBG( BG_B, "PULSA 'B' RESETEAR    ", 10, 10 );
	}
